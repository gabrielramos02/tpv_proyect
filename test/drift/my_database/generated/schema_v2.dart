...
class Tickets extends Table with TableInfo<Tickets, TicketsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TicketsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TicketsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class TicketsData extends DataClass implements Insertable<TicketsData> {
  final int id;
  final double totalPrice;
  final int createdAt;
  const TicketsData({
  ...
  TicketsData copyWith({int? id, double? totalPrice, int? createdAt}) =>
      TicketsData(
        id: id ?? this.id,
        totalPrice: totalPrice ?? this.totalPrice,
        createdAt: createdAt ?? this.createdAt,
      );
  TicketsData copyWithCompanion(TicketsCompanion data) {
    return TicketsData(
      id: data.id.present ? data.id.value : this.id,
      totalPrice: data.totalPrice.present
          ? data.totalPrice.value
  ...
  @override
  String toString() {
    return (StringBuffer('TicketsData(')
          ..write('id: $id, ')
          ..write('totalPrice: $totalPrice, ')
          ..write('createdAt: $createdAt')
          ..write(')'))
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TicketsData &&
          other.id == this.id &&
          other.totalPrice == this.totalPrice &&
          other.createdAt == this.createdAt);
}

class TicketsCompanion extends UpdateCompanion<TicketsData> {
  final Value<int> id;
  final Value<double> totalPrice;
  final Value<int> createdAt;
  ...
  static Insertable<TicketsData> custom({
    Expression<int>? id,
    Expression<double>? totalPrice,
    Expression<int>? createdAt,
  }) {

...
class $OrdersTable extends Orders with TableInfo<$OrdersTable, Order> {
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('rest_table')) {
      context.handle(
        _restTableMeta,
        restTable.isAcceptableOrUnknown(data['rest_table']!, _restTableMeta),
      );
    } else if (isInserting) {
      context.missing(_restTableMeta);
    }
    return context;
  }
...
final class $$RestTablesTableReferences
  ...
  static MultiTypedResultKey<$OrdersTable, List<Order>> _ordersRefsTable(
    ...
    db.orders,
    aliasName: 'rest_tables__id__orders__rest_table',
  );
  ...
  $$OrdersTableProcessedTableManager get ordersRefs {
    final manager = $$OrdersTableTableManager(
      $_db,
      $_db.orders,
    ).filter((f) => f.restTable.id.sqlEquals($_itemColumn<int>('id')!));
...
class $$RestTablesTableFilterComposer
  ...
  Expression<bool> ordersRefs(
    ...
    final $$OrdersTableFilterComposer composer = $composerBuilder(
      ...
      getReferencedColumn: (t) => t.restTable,
      builder:
          (
            joinBuilder, {
                  ...
                  if (ordersRefs)
                    ...
                    >(
                      ...
                      referencedItemsForCurrentItem: (item, referencedItems) =>
                          referencedItems.where((e) => e.restTable == item.id),
                      typedResults: items,
                    ),
                ];
              },
...
final class $$ProductTypesTableTableReferences
  ...
  _productsClassRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.productsClass,
    aliasName: 'product_types_table__id__products_class__type',
  );
...
final class $$TaxesTableReferences
  ...
  _productsClassRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.productsClass,
    aliasName: 'taxes__id__products_class__taxes',
  );
...
final class $$ProductsClassTableReferences
  ...
  static $ProductTypesTableTable _typeTable(_$AppDatabase db) => db
      .productTypesTable
      .createAlias('products_class__type__product_types_table__id');
  ...
  static $TaxesTable _taxesTable(_$AppDatabase db) =>
      db.taxes.createAlias('products_class__taxes__taxes__id');
...
final class $$OrdersTableReferences
  ...
  static $RestTablesTable _restTableTable(_$AppDatabase db) =>
      db.restTables.createAlias('orders__rest_table__rest_tables__id');

  $$RestTablesTableProcessedTableManager get restTable {
    final $_column = $_itemColumn<int>('rest_table')!;

    final manager = $$RestTablesTableTableManager(
      $_db,
      $_db.restTables,
    ).filter((f) => f.id.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_restTableTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
    );
  ...
  _orderLinesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.orderLines,
    aliasName: 'orders__id__order_lines__order',
  );
  ...
  static MultiTypedResultKey<$PaymentsTable, List<Payment>> _paymentsRefsTable(
    ...
    db.payments,
    aliasName: 'orders__id__payments__order',
  );
...
class $$OrdersTableFilterComposer
  ...
  $$RestTablesTableFilterComposer get restTable {
    final $$RestTablesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.restTable,
...
class $$OrdersTableOrderingComposer
  ...
  $$RestTablesTableOrderingComposer get restTable {
...
final class $$OrderLinesTableReferences
  ...
  static $OrdersTable _orderTable(_$AppDatabase db) =>
      db.orders.createAlias('order_lines__order__orders__id');
...
final class $$PaymentsTableReferences
  ...
  static $OrdersTable _orderTable(_$AppDatabase db) =>
      db.orders.createAlias('payments__order__orders__id');
